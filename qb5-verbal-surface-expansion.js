...
(() => {
  ...
  const specs={
    ...
    'reported-vs-fact':[
      ['紀錄寫道：「三位志工表示下週打算參加整理。」哪一句沒有把「打算」說成已發生？','三位志工表示打算下週參加整理',['三位志工已完成整理','下週一定有三位志工參加整理','所有志工都會參加整理'],'紀錄支持的是「表示打算」，不是事情已經完成或必然發生。'],
      ['公告寫道：「主辦方預測明天下午可能下雨。」哪一句最忠實保留原文的證據強度？','主辦方預測明天下午可能下雨',['明天下午一定下雨','今天下午已經下雨','主辦方證實明天下午會下雨'],'「預測」與「可能」都表示不確定，不能改寫成確定事實。']
    ],
    'contrast-focus':[
